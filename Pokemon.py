...
pkm=pd.read_csv('SA2021_W1_Pokemon.csv')
pkm
...
pkm.set_index('Name',inplace=True)
pkm.head()
...
pkm['Abilities']=pkm.Type_1+'+'+pkm.Type_2
pkm[pkm.Abilities=='Psychic+Flying'].describe()


# In[10]:


pkm.index.str.contains('Mega')


# In[31]:


pkm.rename(columns={'Sp. Def':'Sp_Def','Sp. Atk':'Sp_Atk'},inplace=True)
pkm.Sp_Def.describe()
...
pkm[pkm.Legendary==True].describe()
...
pkm[(pkm.Abilities.str.contains('Poison')==True) & (pkm['Attack'].sort_values())]


# In[34]:


pkm[(pkm.Type_1.str.contains('Pyschic')==True) | (pkm.Type_2.str.contains('Psychic')==True)].describe()


# In[35]:


pkm[(pkm.Type_1.str.contains('Steel')==True) | (pkm.Type_2.str.contains('Steel')==True)].describe()


# In[36]:


pkm[(pkm.Type_1.str.contains('Fairy')==True) | (pkm.Type_2.str.contains('Fairy')==True)].describe()


# In[37]:


pkm[pkm.Generation==5].describe()


# In[38]:


po=pkm['Type_1'].value_counts()
po.sort_values()
...
pkm[(pkm.Abilities.str.contains('Ghost')==True) & (pkm.Legendary==False) & (pkm.Generation==4) & (pkm['Speed'].sort_values())]


# In[43]:


pkm['SP']=pkm.Sp_Atk+pkm.Sp_Def
pkm[(pkm.Defense>78) & (pkm.Attack<84) & (pkm.Legendary==False)]
...
pkm.SP.sort_values(ascending=False)
pkm[pkm.index==422]
